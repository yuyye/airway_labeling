...
import os
import numpy as np
from transformer import AirwayFormer_se_prob
...
save_dir = "checkpoints/test_seed{}/".format(seed)
...
my_net = AirwayFormer_se_prob(input_dim=23, num_classes1=6, num_classes2=20, num_classes3=127, dim=128, heads=4,
