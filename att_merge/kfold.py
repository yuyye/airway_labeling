...
for train_index, val_index in kfold.split(dataset1):
    ...
    save_dir = "checkpoints/kfold_{}_att_2_softatt{}_seed{}_dense_headmask_0.1_1_1_1_1_1__transformer_6layer_dim128_heads4_hdim32_mlp256_postnorm_adam5e-4_eps_hierarchy222/".format(
        idx_fold, alpha, seed)
    ...
    for epoch in range(epochs):
        ...
        for case in train_loader_case:
            ...
            loss = loss_function(output11, y_lobar) + loss_function(output21, y_seg) + loss_function(output31,
                                                                                                     y_subseg) + \
                   +  loss_function(output12, y_lobar) + loss_function(output22, y_seg) + loss_function(output32,
                                                                                                        y_subseg)
        ...
        print(
            "epoch:{},loss:{}，acc:{}, {}({}), {}({}，{}), {},{}({}), {}({}, {})time:{}".format(epoch + 1,
                                                                                              train_mean_loss,
                                                                                              train_mean_acc11,
                                                                                              train_mean_acc21,
                                                                                              train_mean_acc2_11,
        ...
        plt.title("kfold_loss{}".format(idx_fold))
        plt.xlabel("epoch")
        plt.ylim(0, 4)
        plt.ylabel("kloss")
        plt.legend(["loss1"])
        ...
        if (epoch + 1) % 10 == 0:
            ...
            print("Accuracy of val Samples:{}, {}({}), {}({}，{}),{},{}({}), {}({}，{})".format(test_mean_acc11,
                                                                                              test_mean_acc21,
                                                                                              test_mean_acc2_11,
                                                                                              test_mean_acc31,
                                                                                              test_mean_acc3_11,
            ...
            if  test_mean_acc32 > max_acc:
                ...
                save_path = os.path.join(save_dir, 'acc_valbest.pkl')
