...
import os
import numpy as np
from att_transformer import AirwayFormer_att_new
...
for train_index, val_index in kfold.split(dataset1):
    ...
    data_train_fold = dataset1[train_index]
    data_val_fold = dataset1[val_index]
    ...
    for epoch in range(epochs):
        ...
        if (epoch + 1) % 10 == 0:
            ...
            print("Accuracy of val Samples:{}, {}({}), {}({}，{}),{},{}({}), {}({}，{})".format(test_mean_acc11, test_mean_acc21,
