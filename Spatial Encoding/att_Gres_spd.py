...
import os
import numpy as np
from transformer_spd import AirwayFormer_att_Gres
...
save_dir = "checkpoints/att_2_se_except_Gres_soft{}_dense_headmask_0.1_1_1_1_1_1_seed{}_transformer_6layer_dim128_heads4_hdim32_mlp256_postnorm_adam5e-4_eps_hierarchy222/".format(alpha,seed)
