...
for train_index, val_index in kfold.split(dataset1):
    ...
    save_dir = "checkpoints/kfold15_fold{}_att_2_soft{}_dense_headmask_0.1_1_1_1_1_1_seed{}_transformer_6layer_dim128_heads4_hdim32_mlp256_postnorm_adam5e-4_eps_hierarchy222/".format(
        idx_fold,alpha, seed)
    ...
    for epoch in range(epochs):
        ...
        if (epoch + 1) % 10 == 0:
            ...
            if epoch>300 and test_mean_acc32 > max_acc:
    ...
    # print("Accuracy of Test Samples:{}, {}({}), {}({}，{}) r->w({},{}) w->r({},{})".format(mean_acc1,mean_acc2,mean_acc2_1,mean_acc3,mean_acc3_1,mean_acc3_2,con_mean_3_1,con_mean_3_2,con_mean_1_3,con_mean_2_3))
    print("Accuracy of Test Samples of kfold{}:{}, {}({}), {}({}，{}),{},{}({}), {}({}，{})".format(idx_fold,test_mean_acc11, test_mean_acc21,
                                                                                       test_mean_acc2_11,
                                                                                       test_mean_acc31,
                                                                                       test_mean_acc3_11,
                                                                                       test_mean_acc3_21,
