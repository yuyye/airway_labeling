...
lca_path = "/home/yuy/code/transformer/LCA/lca/"
epochs = 800
dataset1 = multitask_dataset(train_path2, train_path3, spd_train,lca_path,train=True)
...
dataset2 = multitask_dataset(test_path2, test_path3, spd_test,lca_path,test=True)
...
save_dir = "checkpoints/att_cross_norm_correct_spd_gen_lcanorm_211_seed{}/".format(seed)
...
for epoch in range(epochs):
    ...
    for case in train_loader_case:
        ...
        output11, output21, output31, output12, output22, output32 = my_net(x, spd.detach(),gen.detach(),lca.detach(), 0.1)
    ...
    if (epoch + 1) % 10 == 0:
        ...
        for case in test_loader_case:
            ...
            output11,output21,output31,output12,output22,output32 = my_net(x,spd.detach(),gen.detach(),lca.detach(),0.)
